...
// Proxy — pour l'instant seul le mode naïf (V1) est branché.
// Le pipeline responsable (V2) sera ajouté au Sprint 2.
app.post("/api/chat", naiveProxyHandler);

// Métriques cumulées (alimentent le simulateur de charge et le futur dashboard).
